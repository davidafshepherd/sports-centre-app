    ...
    return (
        <div className="max-w-5xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-[3fr_2fr] gap-6">
                ...
                {/* Right column: stat cards + today's bookings */}
            ...
            <div className="pt-2 border-t border-slate-200 flex justify-center">
                <button
                    ...
                    className="flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-red-600 bg-white border border-red-200 rounded-xl hover:bg-red-50 hover:border-red-300 cursor-pointer transition-colors"
                >
